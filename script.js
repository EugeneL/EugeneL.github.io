...
(function() {
    ...
    serial["CH340"] = async function (obj, baudRate = config.DEFAULT_BAUD_RATE) {
        ...
        await serial.controlledTransfer(obj,"out", "vendor", "device", config.CH340.REG_MODEM_CTRL, config.CH340.REG_MODEМ_VALUE_CALL);
    ...
    serial["CH340"].DISCONNECT = async function (obj) {
        await serial.controlledTransfer(obj,"in", "vendor", "device", config.CH340.REG_MODEМ_CTRL, config.CH340.REG_MODEМ_VALUE_OFF);
    }
